...
export default function PaketTourPage() {
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-2xl font-bold mb-8 mt-10 text-center">Daftar Paket Tour</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="border rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105 duration-300 bg-white dark:bg-gray-100">
          <img src="/images/regular-package.jpg" alt="Paket Reguler" className="w-full h-48 object-cover rounded-t-lg" />
          <div className="p-6">
            <h3 className="text-xl font-bold mb-2 text-green-500">Paket Reguler</h3>
            <p className="text-gray-700 mb-4">Nikmati wisata reguler dengan fasilitas terbaik.</p>
            <Link href="/paket-tour/reguler?jenis_paket=Paket Reguler" className="text-blue-500 hover:underline">
              Read more
            </Link>
          </div>
        </div>
        ...
        <div className="border rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105 duration-300 bg-white dark:bg-gray-100">
          <img src="/images/extraordinary-package.jpg" alt="Paket Extraordinary" className="w-full h-48 object-cover rounded-t-lg" />
          <div className="p-6">
            <h3 className="text-xl font-bold mb-2 text-green-500">Paket Extraordinary</h3>
            <p className="text-gray-700 mb-4">Rasakan pengalaman wisata yang luar biasa.</p>
            <Link href="/paket-tour/extraordinary?jenis_paket=Paket Extraordinary" className="text-blue-500 hover:underline">
              Read more
            </Link>
          </div>
        </div>
        ...
        <div className="border rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105 duration-300 bg-white dark:bg-gray-100">
          <img src="/images/honeymoon-package.jpg" alt="Paket Honeymoon" className="w-full h-48 object-cover rounded-t-lg" />
          <div className="p-6">
            <h3 className="text-xl font-bold mb-2 text-green-500">Paket Honeymoon</h3>
            <p className="text-gray-700 mb-4">Momen romantis tak terlupakan untuk pasangan.</p>
            <Link href="/paket-tour/honeymoon?jenis_paket=Paket Honeymoon" className="text-blue-500 hover:underline">
              Read more
            </Link>
          </div>
        </div>
        ...
        <div className="border rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105 duration-300 bg-white dark:bg-gray-100">
          <img src="/images/onedaytrip-package.jpg" alt="Paket One Day Trip" className="w-full h-48 object-cover rounded-t-lg" />
          <div className="p-6">
            <h3 className="text-xl font-bold mb-2 text-green-500">Paket One Day Trip</h3>
            <p className="text-gray-700 mb-4">Wisata sehari penuh dengan beragam destinasi.</p>
            <Link href="/paket-tour/onedaytrip?jenis_paket=Paket One Day Trip" className="text-blue-500 hover:underline">
              Read more
            </Link>
          </div>
        </div>
