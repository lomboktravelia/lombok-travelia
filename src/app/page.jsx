          ...
          <div className="flex flex-wrap justify-center space-x-8 px-5 gap-5">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <p className="text-gray-600 mb-4">
                Lombok Travelia berkat lombok travelia saya jadi
                lebih bersemangat menjelajahi keindahan lombok, terkhusus kepada
                bapak ronaldo, service yang diberikan sangatlah maksimal.... salut.
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <p className="text-gray-600 mb-4">
                ...
                lebih bersemangat menjelajahi keindahan lombok, terkhusus kepada
                bapak ronaldo, service yang diberikan sangatlah maksimal.... siuu.
              </p>
              <h3 className="text-xl font-bold">Mas Jhon</h3>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <p className="text-gray-600 mb-4">
                Lope lope Lombok Travelia berkat lombok travelia saya jadi
                lebih bersemangat menjelajahi keindahan lombok, terkhusus kepada
                bapak ronaldo, service yang diberikan sangatlah maksimal.... vamos.
              </p>
    ...
    <div className="max-w-2xl mx-auto">
      <div className="border-b mb-4">
        ...
        >
          ...
          <span className={`ml-2 ${faq1Open ? 'transform rotate-180' : ''}`}>&#9660;</span>
        </button>
        {faq1Open && (
      ...
      <div className="border-b mb-4">
        ...
        >
          ...
          <span className={`ml-2 ${faq2Open ? 'transform rotate-180' : ''}`}>&#9660;</span>
        </button>
        {faq2Open && (
          <div className="px-6 py-4">
            <p className="text-gray-600">
      ...
      <div className="border-b mb-4">
        ...
        >
          ...
          <span className={`ml-2 ${faq3Open ? 'transform rotate-180' : ''}`}>&#9660;</span>
        </button>
        {faq3Open && (
          <div className="px-6 py-4">
            <p className="text-gray-600">
      ...
      <div className="border-b mb-4">
        ...
        >
          ...
          <span className={`ml-2 ${faq4Open ? 'transform rotate-180' : ''}`}>&#9660;</span>
        </button>
        {faq4Open && (
          <div className="px-6 py-4">
            <p className="text-gray-600">
